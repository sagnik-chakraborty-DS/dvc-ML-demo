...
def split_and_save(config_path,params_path):
    ...
    #print(train.shape)#1119,12
    #print(test.shape)#480,12
...
if __name__ == '__main__':
    ...
    args.add_argument("--params", "-p", default="params.yaml")#this will give path to params.yaml
    #inorder to get parameter
